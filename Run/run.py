...
#     external_file.close()
# open("bail-fairattr-nifty.txt", "w").close()

# with open("bail-fairattr-nifty.txt", "a") as external_file:
#     #for pp in [0.01,0.1,0.2]:
...
#                    #os.system(stringa1)
#                    stringa = 'python nifty_sota_gnn-fairattr.py --drop_edge_rate_1 0.1 --drop_edge_rate_2 0.1 --dropout 0.5 --hidden 16 --lr 1e-3 --epochs 1000 --model ssf --encoder gcn --dataset bail --sim_coeff 0.6' + ' --drop_feature_rate_1 ' + str(p) + ' --drop_feature_rate_2 ' + str(p) + ' --seed ' + str(r) + ' --fairattr 0'
...
open("german-ultimocomb04.txt", "w").close()

with open("german-ultimocomb04.txt", "a") as external_file:
    #for pp in [0.01,0.1,0.2]:
    external_file.write("dr = 0.1" )
    for p in [0.01]:#, 0.1, 0.2]:
        external_file.write('d_attr_r: ' + str(p))
        for d in [0.4]:
            ...
            for r in [0,1,2]:
               for i in range(0,2): 
                   ...
                   #os.system(stringa1)
                   stringa = 'python nifty_sota_gnn-fairattr.py --drop_edge_rate_1 0.1 --drop_edge_rate_2 0.1 --dropout 0.5 --hidden 16 --lr 1e-3 --epochs 2500 --model ssf --encoder gcn --dataset german --sim_coeff 0.6' + ' --drop_feature_rate_1 ' + str(p) + ' --drop_feature_rate_2 ' + str(p) + ' --seed ' + str(r) + ' --fairattr 0'
                   os.system(stringa)
